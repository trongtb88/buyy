package com.dragon88.microservices.invoice.controller.service;
...
import com.dragon88.microservices.invoice.dto.Item;
import com.dragon88.microservices.invoice.dto.OrderDetail;
...
import com.dragon88.microservices.invoice.repository.InvoiceRepository;
import com.dragon88.microservices.invoice.repository.ItemsRepository;
import com.dragon88.microservices.invoice.repository.ModeOfPayRepository;
...
public class InvoiceService {
	...
	public Boolean createInvoiceAndOrder(OrderDetail orderDetail) {
		...
		ModeOfPay modeOfPay = modeOfPayRepository.findById(orderDetail.getModePayId()).get();
...
//		invoice.setTotalTaxAmount(totalTaxAmount);
		...
		if(null != invoiceSaved) {
			...
			Iterable<Items> itemsList =  itemsRepository.saveAll(itemsEntityList);
			if(null != itemsList) {
			return true;	
			}
		}
